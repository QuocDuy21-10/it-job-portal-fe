...
export default function AdminDashboard() {
  ...
  useEffect(() => {
    ...
    //   const [usersResult, companiesResult, jobsResult, resumesResult] =
    //     await Promise.all([
  ...
  return (
    <div>
      <div className="mb-8">
        ...
        <p className="mt-2 text-gray-600">Manage your job portal efficiently</p>
      </div>
            ...
            <div className="space-y-4">
              <div className="flex justify-between items-center pb-3 border-b">
                ...
                <span className="font-semibold">
                  {stats.users + stats.companies + stats.jobs + stats.resumes}
                </span>
              </div>
              <div className="flex justify-between items-center pb-3 border-b">
            ...
            <div className="space-y-4">
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-xs text-gray-500">
                    Database tables created and populated with mock data
                  </p>
                </div>
              </div>
              <div className="flex items-start gap-3">
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-xs text-gray-500">
                    Job listings and company profiles are live
                  </p>
                </div>
              </div>
            </div>
